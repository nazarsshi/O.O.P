...
public class Main  {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i <Threads ; i++) future_res.add(executorService.submit(new MyCallable(len)));
        ...
        for (int i = 0; i <Threads ; i++) results.add(SequentThread.call());
        ...
        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~+~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        for (int i = 0; i <Threads ; i++) res = future_res.get(i).get();
        System.out.format("|%-15s|%-30s|%-30s|%-35s|%-10s%n","Паралельний|", res[1]+"|", res[2]+"|" ,res[0]+"|" ,res[3]+"|");
        for (int j = 0; j <Threads ; j++) res2 = results.get(j);
