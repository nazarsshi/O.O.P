    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        animation.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                    ...
                    Path path3 = new Path();
                    Path path4 = new Path();
                    path.getElements().add(new MoveTo(500, 450));
                    path1.getElements().add(new MoveTo(520, 470));
                    path2.getElements().add(new MoveTo(540, 490));
                    path3.getElements().add(new MoveTo(560, 510));
                    path4.getElements().add(new MoveTo(580, 530));
                    path.getElements().add(new CubicCurveTo(380, 0, 380, 120, 200, 120));
                    path1.getElements().add(new CubicCurveTo(0, 120, 0, 240, 380, 240));
                    ...
                    path1.getElements().add(new CubicCurveTo(380, 0, 380, 120, 200, 120));
                    path2.getElements().add(new CubicCurveTo(0, 150, 0, 200, 140, 170));
                    path3.getElements().add(new CubicCurveTo(0, 140, 100, 70, 180, 200));
                    path4.getElements().add(new CubicCurveTo(220, 100, 70, 90, 80, 110));
                    ...
                    scaleTransition1.setToX(2.5);
                    scaleTransition1.setToY(2.5);
                    ...
                    scaleTransition3.setToX(2.5);
                    scaleTransition3.setToY(2.5);
                    ...
                    scaleTransition4.setToX(2.5);
                    scaleTransition4.setToY(2.5);
                    ...
                    root.getChildren().addAll(canvas, canvas1, canvas2, canvas3, canvas4);
                ...
                root.getChildren().add(borderPane1);
                    ...
                    stop.setOnMouseClicked(event1 -> {
                        root.getChildren().clear();
                        root.getChildren().addAll(gridPane,flowPane);
                    });
            }
        });
